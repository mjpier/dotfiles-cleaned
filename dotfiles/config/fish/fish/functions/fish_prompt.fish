...
function fish_prompt
  ...
  echo -n -s $prompt_color '[ '$normal $USER ' ' $prompt_color 'at' $normal ' '  $hostname $normal ' ' $prompt_color 'in' $normal ' ' $cwd $prompt_color ' ]' $normal
  ...
  echo -e ''
  echo -e -n -s $prompt_color $prmt $normal
end
